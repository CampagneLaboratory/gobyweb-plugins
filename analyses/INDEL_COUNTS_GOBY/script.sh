...
function plugin_alignment_analysis_process {
   ...
   shift
   shift
   MINIMUM_VARIATION_SUPPORT=${PLUGINS_ALIGNMENT_ANALYSIS_INDEL_COUNTS_MINIMUM_VARIATION_SUPPORT}
   THRESHOLD_DISTINCT_READ_INDICES=${PLUGINS_ALIGNMENT_ANALYSIS_INDEL_COUNTS_THRESHOLD_DISTINCT_READ_INDICES}
   OUTPUT_FORMAT=${PLUGINS_ALIGNMENT_ANALYSIS_INDEL_COUNTS_OUTPUT_FORMAT}
   ...
   # These variables are defined: SLICING_PLAN_FILENAME
     ...
     REALIGNMENT_OPTION=${PLUGINS_ALIGNMENT_ANALYSIS_INDEL_COUNTS_REALIGN_AROUND_INDELS}
